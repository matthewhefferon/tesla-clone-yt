    ...
    <div className="flex justify-between items-center font-bold px-12 p-4 text-sm">
      ...
      <div className="hidden xl:inline">
        <ul className="flex justify-center hover:cursor-pointer">
          ...
          <li className="py-1 px-3 hover:rounded hover:bg-black/5"><a href="https://tesla.com/solarroof">
            Solar Roof
            </a></li>
          <li className="py-1 px-3 hover:rounded hover:bg-black/5"><a href="https://tesla.com/solarpanels">
            Solar Panels
            </a></li>
        </ul>
      </div>
